...
if MySys() == "mac"
	noremap <leader>M :silent exec "!pandoc % -f markdown+smart -s --toc --toc-depth=4 -c ~/local/etc/Blank.css -F mermaid-filter -t html -o %.generated.html; open %.generated.html"<CR>
else
	if MySys() == "linux"
